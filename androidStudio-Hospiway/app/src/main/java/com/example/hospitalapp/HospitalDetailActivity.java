...
public class HospitalDetailActivity extends AppCompatActivity implements IHospitalProvider.HospitalProviderObserver {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        if (hospitalId != null) {
            ...
            this.hospital = hHospitalProvider.getHospital(hospitalId);
            this.makeHospital();
    ...
    public void doCheckIn(View view) {
        ...
        ((GlobalProvider) this.getApplication()).setCheckedIn(true);
        ((GlobalProvider) this.getApplication()).setCheckedInHospital(hospital);
        showPopUp();
        Toast.makeText(this, "Bem-Vindo!", Toast.LENGTH_LONG).show();
    }

    public void doOnWay(View view) {
        ((GlobalProvider) this.getApplication()).setOnTheWay(true);
    ...
    public void openAddressExternalPage(View view) {
        ...
        Location currentLocation = HospitalListActivity.thisLocation;
        Double currentLongitude = currentLocation.getLongitude();
        Double currentLatitude = currentLocation.getLatitude();
        intent.setData(Uri.parse("http://maps.google.com/maps?saddr=" + currentLatitude + "," + currentLongitude + "&daddr=" + hospital.getAddress()));
        startActivity(intent);
    }
    ...
    public void showPopUp() {
        DialogFragment fragment = new CheckInPopUp();
        fragment.show(getSupportFragmentManager(), "popup");
    }
